    ...
    <div className="relative min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-500">
      ...
      <main className="relative pt-32 pb-20 px-6 flex flex-col items-center text-center">
        <section className="flex flex-col items-center gap-12 sm:gap-16 max-w-5xl w-full">
          ...
          <div className="flex flex-col items-center gap-8 md:gap-10 w-full">
            ...
            <div className="flex flex-col items-center gap-6 max-w-3xl">
              <motion.p
                ...
                className="text-2xl sm:text-4xl lg:text-6xl font-medium tracking-tight text-zinc-400 dark:text-zinc-500 leading-tight"
              >
          ...
          >
            <Link href="/dashboard">
              <Button size="lg" className="group h-16 px-10 rounded-2xl text-xl font-bold gap-3 bg-zinc-900 hover:bg-black dark:bg-zinc-100 dark:hover:bg-white text-white dark:text-zinc-900 transition-all active:scale-[0.98] shadow-2xl shadow-zinc-900/20 dark:shadow-zinc-100/10">
                Start Writing
